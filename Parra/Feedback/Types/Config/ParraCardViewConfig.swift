...
protocol ParraConfigurableCardView {
...
public struct ParraCardViewConfig {
    ...
    public init(
        ...
        accessoryTintColor: UIColor? = Constant
            .defaultAccessoryTintColor,
        accessoryDisabledTintColor: UIColor? = Constant
            .defaultAccessoryDisabledTintColor,
    ...
    public enum Constant {
        ...
        public static let defaultContentInsets = UIEdgeInsets(
            top: 20,
            left: 20,
            bottom: 20,
            right: 20
        )
        public static let defaultTintColor = Parra.Constants.brandColor
        public static let defaultAccessoryTintColor = UIColor(hex: 0x5BC0DE)
        public static let defaultAccessoryDisabledTintColor =
            UIColor(hex: 0xE3E4E6)
    }
