...
private let credential = ParraFeedbackCredential(token: UUID().uuidString)
...
//        let authProviderExpectation = expectation(description: "Expect initializer callback")
        ...
        ParraFeedback.setAuthenticationProvider { (completion: @escaping (ParraFeedbackCredential) -> Void) in
