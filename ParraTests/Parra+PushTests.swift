...
class ParraPushTests: MockedParraTestCase {
    ...
    func testCachesPushTokenIfSdkNotInitialized() async throws {
        ...
        let cachedToken = await mockParra.parra.state
            .getCachedTemporaryPushToken()
    ...
    func testRegistrationUploadFailureStoresToken() async {
        ...
        let cachedTokenBefore = await mockParra.parra.state
            .getCachedTemporaryPushToken()
        ...
        let cachedTokenAfter = await mockParra.parra.state
            .getCachedTemporaryPushToken()
