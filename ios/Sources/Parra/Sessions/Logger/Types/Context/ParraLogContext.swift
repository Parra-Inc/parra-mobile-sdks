...
public struct ParraLogContext {
    /// Context around where the actual log came from.
    public let callSiteContext: ParraLoggerCallSiteContext
    ...
    public let loggerContext: ParraLoggerContext?
    ...
    public let bypassEventCreation: Bool
}
