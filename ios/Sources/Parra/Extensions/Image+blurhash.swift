...
//
// https://raw.githubusercontent.com/woltapp/blurhash/refs/heads/master/Swift/BlurHashDecode.swift
// License: https://raw.githubusercontent.com/woltapp/blurhash/refs/heads/master/License.md
        ...
        for y in 0 ..< height {
            for x in 0 ..< width {
                ...
                for j in 0 ..< numY {
                    for i in 0 ..< numX {
                        let basis = cos(
                            Float.pi * Float(x) * Float(i) / Float(width)
                        ) * cos(
